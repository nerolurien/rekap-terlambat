    ...
    <div class="container-fluid p-0 mt-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3 gap-2">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="{{ route('terlambat.create') }}" class="btn btn-primary rounded-pill shadow-sm">
                    <i class="mdi mdi-plus"></i> <span class="d-none d-sm-inline">Tambah</span>
                </a>
                <a href="{{ route('terlambat.export') }}" class="btn btn-success rounded-pill shadow-sm">
                ...
                <div class="card shadow-sm border-0 rounded-3">
                    <div class="card-header bg-white py-3">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                <form class="input-group" role="search" action="{{ route('terlambat.index') }}" method="GET" style="width: 280px;">
                    ...
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @else
                                        @foreach ($late as $index => $lat)
                                            <tr>
                                                <td class="text-center d-none d-md-table-cell">{{ $late->firstItem() + $index }}</td>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-sm">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body text-center pb-4">
                                                                        ...
                                                                        <p class="fs-6 fw-bold text-primary">{{ $lat->student->name }}</p>
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            {{ $late->links('pagination::bootstrap-5') }}
                        </div>
                        @endif
                    </div>
                </div>
                                    ...
                                    @else
                                        @foreach ($rekap as $index => $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-end justify-content-md-center flex-wrap gap-1">
                                                        <a href="{{ route('terlambat.show', $data->student_id) }}" type="button"
                                                        ...
                                                        <a href="{{ route('terlambat.cetak', $data->student_id) }}" class="btn btn-sm btn-danger rounded-pill" type="button">
